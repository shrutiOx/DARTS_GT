...
from dartsgt.layer.vanilla_layer import VANLayer
    ...
    def __init__(self, dim_in, dim_out):
        ...
        for i in range(cfg.gt.layers):
            layers.append(VANLayer(
                ...
                log_attn_weights=cfg.train.mode == 'log-attn-weights'or cfg.gt.pk_explainer.enabled,  #
            ))
