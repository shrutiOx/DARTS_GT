# -*- coding: utf-8 -*-
"""
Created on Thu Aug 14 22:01:06 2025
...
class DiscreteNASLayer(nn.Module):
    ...
    def forward(self, batch):
        ...
        if self.self_attn is not None:
            ...
            kv_combined = kv_combined + cfg.gt.residual_mult * h_in1  
            ...
            if self.global_model_type == 'Transformer':
                h_attn_dense, A = self.self_attn(q_dense, kv_combined_dense, kv_combined_dense,
                                       key_padding_mask=~mask, need_weights=True,
                                       average_attn_weights=False)
                # FIX: Convert back from dense to sparse format
                h_attn = h_attn_dense[mask]  # ← THIS IS THE FIX
