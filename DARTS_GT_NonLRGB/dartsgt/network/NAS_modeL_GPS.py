...
from dartsgt.layer.NAS_layer_GPS import NASLayer
from dartsgt.layer.discrete_nas_layer_GPS import DiscreteNASLayer
...
#@model_wrapper
@register_network('NASModelGPS')
class NASModelGPS(torch.nn.Module):
    """
    ...
    def get_discrete_model(self, optimal_weights,weight_type ):
        ...
        discrete_model = NASModelGPS(cfg.share.dim_in, self.dim_out, create_darts_layers=False)
