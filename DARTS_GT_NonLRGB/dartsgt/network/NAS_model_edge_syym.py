...
from dartsgt.layer.NAS_layer_edge_syym import NASLayer
from dartsgt.layer.discrete_nas_layer_edge_syym import DiscreteNASLayer
...
#@model_wrapper
@register_network('NASModelEdgeSyym')
