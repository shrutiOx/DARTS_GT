# -*- coding: utf-8 -*-
"""
Created on Thu Aug 14 22:05:22 2025
...
from dartsgt.layer.NAS_layer_qproj_syym import NASLayer
from dartsgt.layer.discrete_nas_layer_qproj_syym import DiscreteNASLayer
...
#@model_wrapper
@register_network('NASModelQSyym')
class NASModel(torch.nn.Module):
    ...
    def get_discrete_model(self, optimal_weights,weight_type ):
        ...
        discrete_model = NASModel(cfg.share.dim_in, self.dim_out, create_darts_layers=False)
