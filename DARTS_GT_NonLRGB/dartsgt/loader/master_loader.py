...
from dartsgt.loader.dataset.aqsol_molecules import AQSOL
from dartsgt.loader.dataset.coco_superpixels import COCOSuperpixels
from dartsgt.loader.dataset.malnet_tiny import MalNetTiny
from dartsgt.loader.dataset.voc_superpixels import VOCSuperpixels
from dartsgt.loader.split_generator import (prepare_splits,
                                             set_dataset_splits)
from dartsgt.transform.posenc_stats import compute_posenc_stats
from dartsgt.transform.task_preprocessing import task_specific_preprocessing
from dartsgt.transform.transforms import (pre_transform_in_memory,
...
def preformat_OGB_Graph(dataset_dir, name):
    ...
    if name == 'ogbg-ppa':
        ...
        from dartsgt.loader.ogbg_code2_utils import idx2vocab, \
...
def preformat_PCQM4Mv2Contact(dataset_dir, name):
    ...
    try:
        # Load locally to avoid RDKit dependency until necessary
        from dartsgt.loader.dataset.pcqm4mv2_contact import \
...
def preformat_Peptides(dataset_dir, name):
    ...
    try:
        # Load locally to avoid RDKit dependency until necessary.
        from dartsgt.loader.dataset.peptides_functional import \
            PeptidesFunctionalDataset
        from dartsgt.loader.dataset.peptides_structural import \
